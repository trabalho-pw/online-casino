<template>
  ...
  jogarDealer() {
    // O dealer compra cartas enquanto a pontuação for abaixo de 17
  ...
  parar() {
    // Quando o jogador parar, o dealer começa a jogar
    this.jogoFinalizado = true;
    this.jogarDealer();  // Dealer joga automaticamente
    this.verificarFimDeJogo();
  },

  reiniciarJogo() {
    // Reiniciar o valor do dinheiro para o valor final do jogo anterior
    this.dinheiro = this.dinheiroFinal;
    this.iniciarJogo();  // Reinicia o jogo
  }
    }
...
.jogo-container {
  ...
  width: 60vw; /* Largura do contêiner ajustada */
...
/* Estilo para o placar de dinheiro */
.placar-dinheiro {
  font-size: 20px;
  margin: 10px 0;
  font-weight: bold;
